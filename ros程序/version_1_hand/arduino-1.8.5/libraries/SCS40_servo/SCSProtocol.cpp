...
int SCSProtocol::ProtectTorque(u8 ID, u8 Percent)
{
	return writeByte(ID, 37, Percent);
}

int SCSProtocol::ProtectTime(u8 ID, u8 Time)
{
	return writeByte(ID, 38, Time);
}

int SCSProtocol::OverTorque(u8 ID, u8 Percent)
{
	return writeByte(ID, 39, Percent);
}
...
int SCSProtocol::ReadLoad(u8 ID)
{
