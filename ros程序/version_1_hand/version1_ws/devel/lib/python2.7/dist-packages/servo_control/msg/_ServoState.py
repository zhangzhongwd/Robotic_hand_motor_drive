...
"""autogenerated by genpy from servo_control/ServoState.msg. Do not edit."""
import sys
...
class ServoState(genpy.Message):
  _md5sum = "37c0e1ad113d34ab23273f03f228e896"
  _type = "servo_control/ServoState"
...
int16[] torque"""
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.pos = numpy.frombuffer(str[start:end], dtype=numpy.int16, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sh'%length
      ...
      self.torque = numpy.frombuffer(str[start:end], dtype=numpy.int16, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
